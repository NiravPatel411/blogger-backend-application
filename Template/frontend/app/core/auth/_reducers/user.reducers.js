...
function usersReducer(state, action) {
    ...
    switch (action.type) {
        case user_actions_1.UserActionTypes.UsersPageToggleLoading:
            return __assign({}, state, { listLoading: action.payload.isLoading, lastCreatedUserId: undefined });
        ...
        case user_actions_1.UserActionTypes.UserCreated:
            return exports.adapter.addOne(action.payload.user, __assign({}, state, { lastCreatedUserId: action.payload.user.id }));
