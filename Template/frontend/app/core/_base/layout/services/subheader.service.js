...
var SubheaderService = /** @class */ (function () {
    ...
    SubheaderService.prototype.updateBreadcrumbs = function () {
        ...
        var breadcrumbs = this.getBreadcrumbs(this.asideMenus);
    ...
    SubheaderService.prototype.getBreadcrumbs = function (menus) {
        ...
        var urls = getUrlsFromCurrentUrl(url);
        var breadcrumbs = [];
        var _loop_1 = function (u) {
            var menuPath = this_1.getPath(menus, urls[u]) || [];
...
function getUrlsFromCurrentUrl(currentUrl) {
    var result = [];
    var urlParts = currentUrl.split('/');
    urlParts.reduce(function (accum, item) {
        var url = accum + "/" + item;
        result.push(url);
        return url;
    }, '');
