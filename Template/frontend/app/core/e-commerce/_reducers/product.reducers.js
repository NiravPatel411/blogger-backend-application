...
function productsReducer(state, action) {
    ...
    switch (action.type) {
        case product_actions_1.ProductActionTypes.ProductsPageToggleLoading:
            return __assign({}, state, { listLoading: action.payload.isLoading, lastCreatedProductId: undefined });
        ...
        case product_actions_1.ProductActionTypes.ProductCreated:
            return exports.adapter.addOne(action.payload.product, __assign({}, state, { lastCreatedProductId: action.payload.product.id }));
