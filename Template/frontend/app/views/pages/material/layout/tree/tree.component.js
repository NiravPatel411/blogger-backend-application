...
var TreeComponent = /** @class */ (function () {
    function TreeComponent(database, database2, database3, database4, cdr) {
        ...
        this.dataSource.data = database.initialData();
        this.treeFlattener2 = new tree_2.MatTreeFlattener(this.transformer2, this._getLevel2, this._isExpandable2, this._getChildren2);
        this.treeControl2 = new tree_1.FlatTreeControl(this._getLevel2, this._isExpandable2);
        this.dataSource2 = new tree_2.MatTreeFlatDataSource(this.treeControl2, this.treeFlattener2);
        database2.dataChange.subscribe(function (data) { return _this.dataSource2.data = data; });
        this.treeFlattener3 = new tree_2.MatTreeFlattener(this.transformer3, this.getLevel3, this.isExpandable3, this.getChildren3);
        this.treeControl3 = new tree_1.FlatTreeControl(this.getLevel3, this.isExpandable3);
        this.dataSource3 = new tree_2.MatTreeFlatDataSource(this.treeControl3, this.treeFlattener3);
        database3.dataChange.subscribe(function (data) {
            _this.dataSource3.data = data;
        });
        this.treeFlattener4 = new tree_2.MatTreeFlattener(this.transformer4, this.getLevel4, this.isExpandable4, this.getChildren4);
        this.treeControl4 = new tree_1.FlatTreeControl(this.getLevel4, this.isExpandable4);
        this.dataSource4 = new tree_2.MatTreeFlatDataSource(this.treeControl4, this.treeFlattener4);
