...
var MaterialTableComponent = /** @class */ (function () {
    function MaterialTableComponent(http) {
        ...
        this.dataSource2 = new table_1.MatTableDataSource(ELEMENT_DATA2);
        this.dataSource3 = new table_1.MatTableDataSource(ELEMENT_DATA);
        this.dataSource4 = new table_1.MatTableDataSource(ELEMENT_DATA);
        this.dataSource5 = new table_1.MatTableDataSource(ELEMENT_DATA);
        this.dataSource6 = [];
        ...
        // Assign the data to the data source for the table to render
        this.dataSource7 = new table_1.MatTableDataSource(users);
    }
